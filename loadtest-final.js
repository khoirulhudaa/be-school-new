// =============================================
// loadtest-final.js — FINAL LOAD TEST
// Absensi QR - Realistic Field Simulation
// =============================================
...
async function main() {
  ...
  // 3. Diagnostic
  console.log(`${C.yellow}[3/3] Diagnostic — Testing 5 samples...${C.reset}`);
  ...
  console.log(`\n${C.green}Mulai Final Load Test untuk ${TOTAL_STUDENTS} siswa...\n${C.reset}`);
...
//     } else if (result.status === 400 && result.body?.message?.includes("sudah absen")) {
//       alreadyAbsen++;
//       process.stdout.write(`${C.yellow}⛔${C.reset}`);
//     } else {
//       otherFail++;
...
//     // Jeda realistis (180ms rata-rata)
//     const delay = (i % 10 === 0) ? 400 : 180;
